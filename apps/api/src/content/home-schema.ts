...
/** تحقق من عقد الصفحة الرئيسية قبل حفظ JSON حتى لا تُخزَّن كتل تكسر العرض العام */
export const homePageJsonSchema = z.object({
  version: z.coerce.number().int().refine((v) => v === 1 || v === 2, "Unsupported home page version"),
  meta: z
    .object({
