    ...
    <>
      ...
      <article className="mx-auto max-w-3xl space-y-6 px-4 py-14 text-[var(--dc-text-secondary)] sm:px-6 sm:py-16">
        ...
        <section>
          ...
          <p className="mt-3 leading-relaxed">
            نحتفظ بالبيانات للمدة اللازمة لتحقيق الأغراض المذكورة أو كما يقتضيه القانون. نطبّق تدابير أمنية تقنية
            وتنظيمية معقولة؛ ومع ذلك لا يوجد نقل أو تخزين إلكتروني خالٍ من المخاطر بالكامل.
          </p>
        </section>
        <section>
